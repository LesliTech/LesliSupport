class CreateCloudHelpTicketWorkflowAssignments < ActiveRecord::Migration[6.0]
    def change
        ...
        add_reference :cloud_help_ticket_workflow_assignments, :cloud_help_ticket_workflows, foreign_key: true, index: {name: 'help_ticket_workflow_assignments_workflow'}
