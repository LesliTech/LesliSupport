class CreateCloudHelpTicketCustomFields < ActiveRecord::Migration[6.0]
    def change
        ...
        add_reference :cloud_help_ticket_custom_fields, :users, foreign_key: true
        add_reference :cloud_help_ticket_custom_fields, :cloud_help_tickets, foreign_key: true, index: { name: "help_ticket_custom_fields_tickets" }
    end
end
