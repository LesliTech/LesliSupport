...
module CloudHelp
    module Reports
        class StyleService
            ...
            def self.tickets_general
                return {
                    styles: {
                        ...
                        summary: {b: true, alignment: {vertical: :center}, sz: 12}
                    },
                    sheets: [{
                        widths: [10, nil, nil, nil, 40, nil],
                        rows: [
                            {end_row: 0, columns: [{style_name: :header}]},
                            columns: [
                                {end_column: 0, style_name: :wrap_text},
                                {end_column: 1, style_name: :datetime},
                                {end_column: 4, style_name: :wrap_text},
                                {end_column: 5, style_name: :date},
            ...
            def self.tickets_general_simplified
                return {
                    styles: {
                        bold_only: {b: true},
                        italic_only: {i: true},
                    ...
                    sheets: [{
                        ...
                        rows: [
                            ...
                            columns: [
                                ...
                                {end_column: 7, style_name: :wrap_text},
                                {end_column: 8, style_name: :number}
                            ]
                        ] 
                    }]
                }
