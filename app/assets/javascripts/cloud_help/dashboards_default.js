...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(2), __webpack_require__(34).setImmediate))
...
function addToDebugBar(node) {

    let el = document.getElementById("lesli-debug-bar")

    if (!el) {
        setTimeout(() => addToDebugBar(node), 1000)
    }
...
window.addEventListener('error', event => {
    ...
    let p = document.createElement("P")
    p.innerHTML = event.message
    document.getElementById("lesli-debug-bar").appendChild(p)

})

window.debug = function(data, title=false) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    title.innerText = "Debug bar"

    section.id = "lesli-debug-bar"
...
// EXTERNAL MODULE: ./node_modules/lesli-nodejs-debug-message/browser-bar.js
var browser_bar = __webpack_require__(31);
...
var chatboxvue_type_template_id_20e92c73_render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
...
var chatboxvue_type_template_id_20e92c73_staticRenderFns = [
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
...
chatboxvue_type_template_id_20e92c73_render._withStripped = true
...
var chatbox_component = normalizeComponent(
  ...
  chatboxvue_type_template_id_20e92c73_render,
  chatboxvue_type_template_id_20e92c73_staticRenderFns,
  false,
  null,
  null,
  null
...
chatbox_component.options.__file = "app/vue/layout/chatbox.vue"
/* harmony default export */ var chatbox = (chatbox_component.exports);
// CONCATENATED MODULE: ./app/vue/apps/lesli.js
/*
Lesli
...
vue_default.a.use(plugins_http); // · LesliCloud app
// · ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~
...
functions_document.ready(function () {
  ...
  if (false) {}
  if (true) browser_default.a.info("Dashboard simple", "CloudLesli");
});
