...
@description App that retrieves and shows, and allows the user to edit/update a
    Ticket category specified by the id in the route.
...
export default {
    ...
    methods: {
        ...
        getTicketCategory(){
            this.http.get(`${this.main_route}/${this.ticket_category_id}.json`).then(result => {
...
<template>
    <section class="section">
        <component-form v-if="ticket_category" :ticket-category="ticket_category" view-type="edit"/>
