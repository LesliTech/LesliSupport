...
module CloudHelp
    class Account < ApplicationRecord
        ...
        has_many :settings,             class_name: "CloudHelp::Account::Setting",          foreign_key: "cloud_help_accounts_id"
        ...
        has_many :ticket_workspaces,    class_name: "CloudHelp::Catalog::TicketWorkspace",  foreign_key: "cloud_help_accounts_id"
